...
> [!IMPORTANT]
> **وضعیت انتشار: آلفا.** نسخه‌ی منتشرشده‌ی فعلی `v1.0.0-alpha` است و در مشخصات بسته‌ی پایتون با `1.0.0a0` نمایش داده می‌شود. این نسخه هنوز پایدار محسوب نمی‌شود. پیش از انتشار `v1.0.0` باید [چک‌لیست انتشار پایدار](docs/stable-release-checklist.md) کامل شود.
...
روش‌های احراز هویت پشتیبانی‌شده در نسخه `v1.0.0-alpha`:
